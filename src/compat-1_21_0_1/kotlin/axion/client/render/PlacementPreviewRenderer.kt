...
object PlacementPreviewRenderer {
    ...
    fun render(context: AxionWorldRenderContext) {
        ...
        // The source blocks are still present in the world until confirmation.
        // A second textured source preview looks like an offset destination,
        // so placement mode renders only the ghost inside the active box.
