...
internal fun owoGrayLabel(text: String): LabelComponent =
    UIComponents.label(Text.literal(text).formatted(net.minecraft.util.Formatting.GRAY))

internal fun owoBoldLabel(text: String): LabelComponent =
    UIComponents.label(Text.literal(text).formatted(net.minecraft.util.Formatting.BOLD))
