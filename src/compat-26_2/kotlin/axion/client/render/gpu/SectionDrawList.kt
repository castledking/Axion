...
class SectionDrawEntry(
    ...
    @JvmField val indexType: com.mojang.blaze3d.IndexType,
)
...
object SectionDrawList {
    fun buildAll(sectionBuffers: Long2ObjectMap<AxionPreviewBuffer>): ArrayList<SectionDrawEntry> {
        ...
        while (iter.hasNext()) {
            ...
            result += SectionDrawEntry(sectionKey, originX, originY, originZ, buf, buf.indexCountValue, buf.indexTypeValue)
        }
        return result
    }
