...
interface VersionCompat {
    ...
    fun itemStackToNbt(stack: ItemStack): CompoundTag
    fun nbtToItemStack(nbt: CompoundTag): ItemStack
    ...
    fun entityTypeLoadEntityWithPassengers(tag: CompoundTag, world: Any, spawnReason: Any, entityProcessor: (Any) -> Any): Any?
