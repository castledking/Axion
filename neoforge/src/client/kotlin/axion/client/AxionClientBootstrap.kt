...
object AxionClientBootstrap {
    ...
    fun initialize() {
        ...
        logger.info("[Axion/Bootstrap] Keybindings prepared")
        ...
        VersionCompatImpl.onEndClientTick(AxionTickHandler::onEndTick)
        logger.info("[Axion/Bootstrap] Client tick handler registered")
        VersionCompatImpl.onClientStopping(SavedHotbarController::flushActiveHotbar)
        VersionCompatImpl.onClientStopping { MoveSourceRenderState.clear() }
