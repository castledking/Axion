...
object AxionClientConfig {
    ...
    private val path: Path = FMLPaths.GAMEDIR.get().resolve("config").resolve("axion-client.json")
    private val savedHotbarsPath: Path = FMLPaths.GAMEDIR.get().resolve("axion/saved-hotbars.json")
