[![Axion Banner](http://castled.codes/assets/axion-banner.png)](https://github.com/castledking/Axion/wiki/)
...
Axion brings high-speed creative building tools directly into Minecraft with clean real-time previews, region-based editing, global builder modes, symmetry support, and multiplayer-safe execution through the Paper plugin.
...
- Minor tool behavior cleanup and keybind display rework needed

## Todo

- Add more Axiom features like saved hotbars, flying speed, gradient picker, etc.
