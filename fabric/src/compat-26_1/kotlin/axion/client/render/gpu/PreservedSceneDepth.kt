...
/**
 * Owns a depth-only copy of the completed world frame.
 *
 * GameRenderer clears the main target's depth for the hand before it composites
 * glowing entity outlines. Axion draws after that composite, so retaining only
 * the main depth view would attach a valid but already-cleared texture.
 */
