...
object AxionClientBootstrap {
    ...
    fun initialize() {
        ...
        // Registered through the bridge so owo-lib stays optional: a direct
        // AxionEditorUi::render reference loads owo types at startup.
        VersionCompatImpl.registerEditorHudElement(editorHudId, AxionEditorUiBridge::render)
